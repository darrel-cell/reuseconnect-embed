...
const getMainNavItems = (role: string): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { title: "New Booking", url: "/booking", icon: CalendarPlus, roles: ['admin', 'head_of_operation', 'client'], category: "operations" },
    { title: "Jobs", url: "/jobs", icon: ListTodo, roles: ['admin', 'head_of_operation', 'client', 'partner', 'driver'], category: "operations" },
    { title: "Warehouse Process", url: "/jobs", icon: Warehouse, roles: ['warehouse_technician'], category: "warehouse" },
    { title: "Route & Schedule", url: "/driver/schedule", icon: RouteIcon, roles: ['driver', 'head_of_operation'], category: "operations" },
    { title: "Job History", url: "/jobs/history", icon: History, roles: ['driver', 'head_of_operation', 'warehouse_technician'], category: "operations" },
    { title: "Bookings", url: "/bookings", icon: CalendarCheck, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "operations" },
    { title: "Booking Queue", url: "/admin/bookings", icon: ListOrdered, roles: ['admin', 'head_of_operation'], category: "operations" },
    { title: "Sites", url: "/sites", icon: MapPin, roles: ['admin', 'head_of_operation', 'client'], category: "organization" },
    { title: "Inventory", url: "/inventory", icon: Boxes, roles: ['admin', 'head_of_operation', 'client'], category: "warehouse" },
    { title: "Documents", url: "/documents", icon: FolderOpen, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "documents" },
    { title: "CO₂e Overview", url: "/co2e", icon: ChartPie, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "co2" },
    { title: "Organisation", url: "/co2e?view=organisation", icon: Landmark, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "co2" },
    { title: "User", url: "/co2e?view=user", icon: User, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "co2" },
    { title: "Serial Number", url: "/co2e?view=serial", icon: ScanBarcode, roles: ['admin', 'head_of_operation', 'client', 'partner'], category: "co2" },
  ];
